<x-employee-layout>
    @section('title')
        {{ __('admin.user_management') }} | {{ __('admin.user_management_rider_add') }}
    @endsection
    @section('VendorsCss')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 breadcrumb-wrapper mb-4">
            ...
            {{ __('admin.user_management_rider_add') }}
        </h4>

        <div class="card p-3  mb-4">
            <form method="POST" class=" needs-validation" novalidate action="{{ route('employee.users_rider_store') }}"
                ...
                <div class="row pt-3  g-3 ">
                    ...
                    <div class="col-md-4">
                        ...
                        <input required type="email" name="rider_email" id="rider_email" class="form-control"
                            placeholder="{{ __('admin.user_management_rider_email') }}"
                            value="{{ old('rider_email') }}" />
                    </div>
                    <div class="col-md-4">
                        <label class="form-label"
                            for="rider_password">{{ __('admin.user_management_rider_password') }}</label>
                        <input required type="text" name="rider_password" id="rider_password" class="form-control"
                            placeholder="{{ __('admin.user_management_rider_password') }}"
                    ...
                    <div class="col-md-12">
                        ...
                        <input required type="text" name="rider_address_english" id="rider_address_english"
                            ...
                            value="{{ old('rider_address_english') }}"
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control" name="rider_image" type="file" id="rider_image" required
