                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        ...
                        <div class="d-flex justify-content-around mb-4">
                            ...
                            <a data-url="{{ route('employee.users_employee_destroy', $data['id']) }}"
                            ...
                            <div class="modal-content p-3 p-md-5">
                                <div class="modal-body">
                                    ...
                                    <form id="update_passwordForm" class="row g-3 mt-3" method="POST"
                                        ...
                                        action="{{ route('employee.users_employee_update_password') }}">
                                        @csrf
                                        <div class="col-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <span
                                        class="badge rounded-pill {{ $data->status == 1 ? 'bg-label-success' : 'bg-label-danger' }}">{{ $data->status == 1 ? 'Yes' : 'No' }}</span>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-sm-3">
                                    <p class="mb-0">Sales Account?</p>
                                </div>
                                <div class="col-sm-9">
                                    <span
                                        class="badge rounded-pill {{ $data->is_sales == 1 ? 'bg-label-success' : 'bg-label-danger' }}">{{ $data->is_sales == 1 ? 'Yes' : 'No' }}</span>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
