    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card p-3  mb-4">
            <form method="POST" class=" needs-validation" novalidate
                action="{{ route('employee.users_employee_update') }}" enctype="multipart/form-data" class="card-body">
                @csrf
                ...
                <div class="row pt-3  g-3 ">
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="employee_role" name="employee_role[]" value="{{ old('employee_role') }}"
                            ...
                            required data-allow-clear="true" aria-label="employee_role select example">
