<x-employee-layout>
    @section('title')
        ...
        {{ __('admin.accounts_expenses') }} | {{ __('admin.accounts_expenses') }}
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card p-3  mb-4">
            <form method="POST" class=" needs-validation" novalidate action="{{ route('employee.warehouse_update',$warehouse['id']) }}"
                ...
                <div class="row pt-3  g-3 ">
                    <div class="col-md-6">
                        ...
                        <input required type="text" name="warehouse_name_en" id="warehouse_name_en"
                            ...
                            value="{{ $warehouse ->getTranslation('warehouse_name','en') }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input required type="text" name="warehouse_name_ar" id="warehouse_name_ar"
                            ...
                            value="{{ $warehouse ->getTranslation('warehouse_name','ar') }}"
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <select class="form-select" id="branch_id"  aria-label="Default select example" name="branch_id">
                            ...
                            @foreach ($branches as $branch )
                                <option value={{ $branch->id }} {{ $branch->id ==$warehouse->branch_id? 'selected':'' }}>{{ $branch->branch_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3 col-md-6">
