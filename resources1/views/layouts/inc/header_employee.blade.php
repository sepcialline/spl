            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <a class="dropdown-item" href="#">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        <span
                                            class="fw-semibold d-block lh-1">{{ Auth::guard('employee')->user()->name }}
                                        </span>
                                        @foreach (Auth::guard('employee')->user()->roles->pluck('name') as $role)
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ route('employee.employee_profile_index') }}">
