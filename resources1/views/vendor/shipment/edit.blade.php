<x-vendor-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <form action="{{ route('vendor.shipments_update') }}" method="POST" class="row g-3 needs-validation"
            novalidate>
            @csrf
                            ...
                            <div class="row p-sm-3 p-0">
                                <div class="col-md-12 col-sm-12 col-12 mb-sm-0 mb-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col">
                                            <label class="form-label"
                                                for="client_email">{{ __('admin.shipments_client_email') }}</label>
                            ...
                            <div class="row p-sm-3 p-0">
                                <div class="col-md-12 col-sm-12 col-12 mb-sm-0 mb-4">
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" id="delivery_fees" name='delivery_fees'
                                                    readonly value="{{ $shipment->delivery_fees }}"
                                    ...
                                    <div class="row">
                                        ...
                                        @php
                                            $main_office = App\Models\Branches::where('is_main', 1)
                                                ->where('deleted_at', null)
                                                ->first();
                                        @endphp
                                        <input type="hidden" name="branch_created_id"
                                            value="{{ $main_office->id }}">
                                        <input type="hidden" name="branch_destination_id"
                                            value="{{ $main_office->id }}">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                {{-- <div class="col {{ $has_stock == 0 ? 'd-block' : 'd-none' }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="content_text" rows="2" id="content_text" placeholder="">{{ $has_stock == 0 ? $shipment_content->content_text : '' }}</textarea>
                                    </div>
                                </div> --}}
                            </div>
                            <hr class="mx-n4" />
    ...
    @section('VendorsJS')
        ...
        <script>
            $(document).on('change', '#company_id', function() {
                ...
                $.ajax({
                    method: "get",
                    url: "{{ route('vendor.shipment_company_has_stock') }}",
                    data: {
        ...
        <script>
            $(document).on('change', '#shipment_product', function() {
                ...
                $.ajax({
                    url: "{{ route('vendor.shipment_prodcut_details') }}",
                    type: "GET",
                    data: {
        ...
        <script>
            $(document).on('change', '#client_emirate_id', function() {
                ...
                $.ajax({
                    type: 'GET',
                    url: "{{ route('vendor.shipment_get_cities') }}",
                    data: {
                        emirate_id: $(this).val()
                    },
                    success: function(res) {
            ...
            $(document).on('click', '.return_product', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: 'get',
                            url: "{{ route('vendor.return_product_to_stock') }}",
                            data: {
                                id: id,
                                branch_id: branch_id
                            },
        ...
        {{-- <script>
            $(document).on('focusout', '#client_phone', function() {
                ...
                $.ajax({
                    method: "GET",
                    url: "{{ route('vendor.getShipmentClient') }}",
                    data: {
                        mobile: mobile
                    },
                    success: function(res) {
