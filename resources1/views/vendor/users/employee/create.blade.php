<x-vendor-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card p-3  mb-4">
            <form method="POST" class=" needs-validation" novalidate action="{{ route('vendor.users_employee_store') }}"
                ...
                <div class="row pt-3  g-3 ">
                    ...
                    <div class="col-md-4">
                        ...
                        <input required type="text" name="employee_password" id="employee_password" class="form-control"
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="employee_department" value="{{ old('employee_department') }}"
                            class="form-select  @error('user_department') is-invalid @enderror" id="employee_department"
