                ...
                <div class="d-flex ">
                    <div class="form-outline me-2">
                        ...
                        <input type="search" id="form1" class="form-control" placeholder="Type query"
                            aria-label="Search" data-url="{{ route('vendor.users_employee_search', '') }}" />
                    </div>
                    <a href="{{ route('vendor.users_employee_create') }}"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a id="delete" class="btn btn-label-danger delete"
                                        data-url="{{ route('vendor.users_employee_destroy', $item['id']) }}">{{ __('admin.branch_action_delete') }}</a>
                                </td>
                            </tr>
                        @endforeach
