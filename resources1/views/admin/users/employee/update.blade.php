<x-setting-layout>
    @section('title')
        {{ __('admin.user_management_employee') }} | {{ __('admin.user_management_employee_update') }}
    @endsection
    @section('VendorsCss')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 breadcrumb-wrapper mb-4">
            ...
            {{ __('admin.user_management_employee_update') }}
        </h4>
        <div class="card p-3  mb-4">
            <form method="POST" class=" needs-validation" novalidate
                action="{{ route('admin.users_employee_update') }}" enctype="multipart/form-data" class="card-body">
                @csrf
                ...
                <div class="row pt-3  g-3 ">
                    ...
                    <div class=" col-md-4">
                        ...
                        <select name="employee_status" value="{{ old('employee_status') }}" required
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="employee_role" name="employee_role[]" value="{{ old('employee_role') }}"
                            ...
                            data-allow-clear="true" aria-label="employee_role select example" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="user_emirate" value="{{ old('user_emirate') }}"
                            ...
                            aria-label="user_emirate select example" required>
                    ...
                    <div class=" col-md-4">
                        ...
                        <select name="employee_is_sale" value="{{ $data->admin_is_sales }}" required
