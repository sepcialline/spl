    ...
    <div class="container-xxl flex-grow-1 container-p-y ">
        ...
        <div class="card p-4">
            <div class="d-flex justify-content-sm-between align-items-sm-center">
                <h5 class="card-header"> {{ __('admin.user_management_admin_list') }}</h5>
                <div class="d-flex ">
                    <div class="form-outline me-2">
                        ...
                        <input type="search" id="form1" class="form-control" placeholder="Type query"
                            aria-label="Search" data-url="{{ route('admin.users_admin_search', '') }}" />
                    </div>
                    @can('admin-admin-add')
                        <a href="{{ route('admin.users_admin_create') }}"
                            class="btn btn-label-secondary">{{ __('admin.user_management_admin_add') }}</a>
                    @endcan
                </div>
                        ...
                        @foreach ($data as $item)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    😎
                                    @else
                                    @can('admin-admin-Change-Status')
                                    <label class="switch switch-primary">
                                        <input type="checkbox" class="switch-input status"
                                            data-url="{{ route('admin.users_admin_update_status', $item['id']) }}"
