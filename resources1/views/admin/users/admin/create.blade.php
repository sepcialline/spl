<x-app-layout>
    @section('title')
        {{ __('admin.user_management') }} | {{ __('admin.user_management_admin_add') }}
    @endsection
    @section('VendorsCss')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 breadcrumb-wrapper mb-4">
            ...
            {{ __('admin.user_management_admin_add') }}
        </h4>

        <div class="card p-3  mb-4">
            <form method="POST" class=" needs-validation" novalidate action="{{ route('admin.users_admin_store') }}"
                ...
                <div class="row pt-3  g-3 ">
                    ...
                    <div class=" col-md-2">
                        ...
                        <select name="admin_is_sale" value="{{ old('admin_is_sale') }}" required
