...
@endif
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card p-3  mb-4">
            <form method="POST" class=" needs-validation" novalidate action="{{ route('admin.users_rider_update') }}"
                ...
                <div class="row pt-3  g-3 ">
                    ...
                    <div class="col-md-4">
                        ...
                        <input required type="text" name="rider_mobile" id="rider_mobile"
                            class="form-control" placeholder="{{ __('admin.user_management_rider_mobile') }}"
                            value="{{ $data->mobile }}" />
                    </div>
                    <div class="col-md-4">
                        <label class="form-label"
                            for="rider_email">{{ __('admin.user_management_rider_email') }}</label>
                        <input required type="email" name="rider_email" id="rider_email"
                            class="form-control" placeholder="{{ __('admin.user_management_rider_email') }}"
                            value="{{ $data->email }}" />
                    </div>
                    {{-- <div class="col-md-4">
                        <label class="form-label"
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="user_branch" value="{{ old('user_branch') }}"
                    ...
                    <div class=" col-md-2">
                        ...
                        <select name="rider_status" value="{{ old('rider_status') }}"
                            class="form-select  @error('rider_status') is-invalid @enderror"
                            id="rider_status" aria-label="rider_status select example">
                            {{-- <option selected>Open this select menu</option> --}}
                            <option value="0" {{ $data->status == '0'?'selected':''}}>{{ __('admin.no') }}</option>
                            <option value="1" {{ $data->status == '1'?'selected':''}}>{{ __('admin.yes') }}</option>
                        </select>
                        @error('rider_status')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-4">
                        ...
                        <label for="rider_image" class="form-label">{{ __('admin.user_management_admin_avatar') }}</label>
                        <input class="form-control"  name="rider_image" type="file" id="rider_image" onchange="document.getElementById('avatar').src=window.URL.createObjectURL(this.files[0])">
                    </div>
                </div>
