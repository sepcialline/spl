<x-app-layout>
    ...
    @section('title')
        {{ __('admin.reports') }} | {{ __('admin.emirate_post') }}
    @endsection
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="py-3 breadcrumb-wrapper mb-4">
            ...
            {{ __('admin.emirate_post') }}
        </h4>

        <div class="card">
            <div class="card-body">
                <form class="row g-3 needs-validation was-validated" method="post"
                    action="{{ route('admin.emirate_post_download') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6 col-12 mb-4">
                            ...
                            <button class="btn btn-success my-4">{{ __('admin.export') }}</button>
                        </div>
                    </div>
                </form>
            </div>
