<x-setting-layout>
    @section('title')
    {{ __('admin.finance_year') }} / {{ __('admin.finance_year_add') }}
    @endsection
    @section('VendorsCss')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 breadcrumb-wrapper mb-4">
            <span class="text-muted fw-light"> {{ __('admin.finance_year') }} / </span>
            {{ __('admin.finance_year_add') }}
        </h4>
        <div class="card p-3  mb-4">
            <form method="POST" class=" needs-validation" novalidate action="{{ route('admin.finance_year_store') }}" enctype="multipart/form-data"
                class="card-body">
                @csrf
                <div class="row pt-3  g-3 ">
                    <div class="col-md-6">
                        <label class="form-label" for="finance_year">{{  __('admin.finance_year_year')
                            }}</label>
                        <input required   type="text" name="finance_year" id="finance_year"
                            class="form-control @error('finance_year') is-invalid @enderror"
                            value="{{ old('finance_year') }}"
                            placeholder="{{ __('admin.finance_year_year') }}" />
                        @error('finance_year')
                    ...
                    <div class="col-md-6">
                        <label for="finance_month" class="form-label">{{ __('admin.finance_year_month') }}</label>
                        <select class="form-select   @error('finance_month') is-invalid @enderror"
                            value="finance_month" id="finance_month" name="finance_month" class="custom-select ">
