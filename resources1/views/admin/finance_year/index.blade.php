    ...
    <div class="container-xxl flex-grow-1 container-p-y ">
        ...
        <div class="card p-4">
            <div class="d-flex justify-content-sm-between align-items-sm-center">
                <h5 class="card-header"> {{ __('admin.finance_year_list') }}</h5>
                <a href="{{ route('admin.finance_year_create') }}"
                    class="btn btn-label-secondary">{{ __('admin.finance_year_add') }}</a>
            ...
            <div class="card-datatable table-responsive text-nowrap px-2 py-2">
                <table class="dt-scrollableTable table table-bordered">
                    <thead>
                        <tr>
                            <th>{{ __('admin.finance_year_year') }}</th>
                            <th>{{ __('admin.finance_year_month') }}</th>
                            <th style="width: 10%">{{ __('admin.finance_year_status') }}</th>
                            ...
                            <td>
                                <label class="switch switch-primary">
                                    <input type="checkbox" class="switch-input status"
                                        data-url="{{ route('admin.finance_status_update', $row['id']) }}" name="status"
