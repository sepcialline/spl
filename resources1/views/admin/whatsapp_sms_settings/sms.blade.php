              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item" >
                      <a class="nav-link " style="border-radius: 10px;" href="{{ route('admin.whatsapp_settings') }}"
                        > {{ __('admin.whatsapp_sms_whatsapp') }}</a>
                    </li>
                    <li class="nav-item" style="background-color: #4287f5;border-radius: 10px;">
                        <a class="nav-link active" style="border-radius: 10px;" href="{{ route('admin.sms_settings') }}"
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="col-xl-12 px-4 py-2">
                        {{-- <h6 class="text-muted">Basic</h6> --}}
                            ...
                            {{-- English --}}
                            <div class="col-md-12">
                                <label class="form-label" for="mail">{{  __('admin.mail_email')
                                    }}</label>
                                <input required   type="text" name="mail" id="mail"
                                    class="form-control @error('mail') is-invalid @enderror" placeholder="{{ __('admin.mail_email') }}"/>
                                @error('mail')
