<x-app-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <form action="{{ route('admin.shipments_store') }}" method="POST" class="row g-3 needs-validation" novalidate>
            @csrf
                ...
                <div class="col-md-9 col-sm-12">
                    <div class="card invoice-preview-card">
                        <div class="card-body">
                            ...
                            <input type="hidden" name="shopify_order_id" value="{{ $order->order_id }}">
                            <hr class="my-2 mx-n4" />
                            {{-- /////////////////   Client Details    //////////// --}}
                            <div class="row p-sm-3 p-0">
                                <div class="col-md-12 col-sm-12 col-12 mb-sm-0 mb-4">
                                    ...
                                    {{-- @php
                                        ...
                                        $str = "$order->phone_no";
                                        $subst = '';
                                        $phone_no = preg_replace($re, $subst, $str);
                                        ...
                                        <div class="mb-3 col">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="client_phone" name="client_phone"
                                                    ...
                                                    required placeholder="5xxxxxxxx" aria-label="" />
                                                <div class="invalid-feedback">{{ __('admin.this_field_is_required') }}
                                                    @error('client_phone')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col">
                                            ...
                                            <span class="text-warning">({{ $order->emirate }})</span>
                                            <select
                                                ...
                                                @foreach ($emirates as $emirate)
                                                    <option value="{{ $emirate->id }}"
                                                        {{ $order->emirate === $emirate->getTranslation('name', 'en') || $order->emirate === $emirate->getTranslation('name', 'ar') ? 'selected' : '' }}>
                                                        {{ $emirate->name }}</option>
                                                @endforeach
                                            </select>
                                            <div class="invalid-feedback">{{ __('admin.this_field_is_required') }}
                                ...
                                <div class="col-md-12 col-sm-12 col-12 mb-sm-0 mb-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <div class="mb-3 col">
                                                <label class="form-label"
                                                    for="client_name">{{ __('admin.payment_method') }} <br><span class="text-danger">{{ $order->payment_gateway_names ?? '' }} <br></span>({{$order->financial_status}})</label>
                                                <select
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($fees_types as $fees_type)
                                                        <option value="{{ $fees_type->id }}"
                                                            {{ old('fees_type_id') == $fees_type->id ? 'selected' : '' }}>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="shipment_notes" rows="2" id="shipment_notes" placeholder=""></textarea>
                                    </div>
                                </div>
                            ...
                            <ul>
                                ...
                                <li>{{$content->product_name}} : {{$content->quantity}}</li>
                                @endforeach
                            </ul>
                            {{-- Shipment Contents  --}}
        ...
        <script>
            $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    data: {
                        emirate_id: $('#client_emirate_id').val()
                    },
                    success: function(res) {
