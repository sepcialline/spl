<x-app-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 breadcrumb-wrapper mb-4">
            ...
            Add Merchant{{-- {{ __('admin.branch_add_branch') }} --}}
        </h4>
        <div class="card p-3  mb-4">
            <form method="POST" class=" needs-validation" novalidate action="{{ route('admin.shopify_store') }}"
                enctype="multipart/form-data" class="card-body">
                @csrf
                <div class="row pt-3  g-3 ">
                    <div class="col-md-12">
                        <label class="form-label"
                            for="merchant_name">Name</label>
                        <input required type="text" name="merchant_name" id="merchant_name"
