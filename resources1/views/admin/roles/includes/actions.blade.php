<div class="row">
    ...
    <div class="col-2 mx-2">
        ...
        @can('admin-role-delete')
            <form method="POST" action="{{ route('admin.roles_admin_destroy', $role->id) }}">
                @csrf
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-add-new-role">
        <div class="modal-content p-3 p-md-5">
            ...
            <div class="modal-body">
                ...
                <!-- Add role form -->
                <form action="{{ route('admin.roles_admin_update') }}" method="post" class="needs-validation"
                    novalidate>
                    @csrf
                                                        ...
                                                        @if (Spatie\Permission\Models\Permission::where('id', $permission->id)->whereIn('id', $perm_role)->first())
                                                            <div class="form-check me-3 me-lg-5">
                                                                <label class="form-check-label"
                                                                    for="userManagementRead">
                                                                    <button
                                                                        class="btn btn-label-dark btn-sm px-2 py-0">{{ $permission->short_name }}</button>
                                                                </label>
                                                            </div>
                                                            <br />
                                                        @else
