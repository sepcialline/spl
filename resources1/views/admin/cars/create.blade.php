<x-app-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card p-3  mb-4">
            <form method="POST" class=" needs-validation" novalidate action="{{ route('admin.cars_store') }}" enctype="multipart/form-data"
                class="card-body">
               @csrf
                <div class="row pt-3  g-3 ">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" value="{{ old('car_plate') }}" name="car_plate">
                        @error('emirates')
