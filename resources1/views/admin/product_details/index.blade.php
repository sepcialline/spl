                                                ...
                                                <div class="modal-content p-3 p-md-5">
                                                    <div class="modal-body">
                                                        ...
                                                        <form id="import_product" class="row g-3 mt-3 needs-validation" novalidate method="POST"
                                                            novalidate
                                                            action="{{ route('admin.product_details_store') }}">
                                                            @csrf
                                                                ...
                                                                <div class="col-6">
                                                                    ...
                                                                    <div class="input-group input-group-merge ">
                                                                        <input type="number" id="total_import_export"
                                                                            required name="total_import_export"
                                                                            class="form-control"
                                                                ...
                                                                <div class="col-6">
                                                                    ...
                                                                    <div class="input-group input-group-merge ">
                                                                        <input type="date" id="date_import_export"
                                                                            required name="date_import_export"
                                                                            class="form-control"
                                                        ...
                                                        <form id="export_product" class="row g-3 mt-3 needs-validation" novalidate method="POST"
                                                            ...
                                                            <div class="col-12 row">
                                                                ...
                                                                <div class="col-6">
                                                                    ...
                                                                    <div class="input-group input-group-merge ">
                                                                        <input type="number" id="total_import_export"
                                                                            name="total_import_export" required
                                                                ...
                                                                <div class="col-6">
                                                                    ...
                                                                    <div class="input-group input-group-merge ">
                                                                        <input type="date" id="date_import_export"
                                                                            name="date_import_export" required
                                                                            class="form-control" {{-- //value={{ $row->quantity }} --}}
                                                                ...
                                                                <div class="col-12">
                                                                    <label class="form-label mt-2"
                                                                        for="notes">{{ __('admin.products_notes') }}</label>
                                                                    <textarea id="autosize-demo" rows="3" name="notes" class="form-control" required></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <button type="submit"
                                            ...
                                            <div class="modal-dialog modal-simple modal-lg modal-dialog-centered">
                                                <div class="modal-content p-3 p-md-5">
                                                    <div class="modal-body">
                                                        ...
                                                        <form id="import_export_product" class="row g-3 mt-3 needs-validation" novalidate
                                                            method="POST"
                                                            action="{{ route('admin.product_details_store') }}">
                                                            @csrf
                                                            <div class="col-12 row">
                                            ...
                                            <div class="modal-dialog modal-simple modal-lg modal-dialog-centered">
                                                <div class="modal-content p-3 p-md-5">
                                                    <div class="modal-body">
                                                        ...
                                                        <form id="import_export_product" class="row g-3 mt-3 needs-validation" novalidate
                                                            method="POST"
                                                            action="{{ route('admin.transfer_product_store') }}">
                                                            @csrf
