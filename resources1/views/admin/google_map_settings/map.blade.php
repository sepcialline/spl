          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">{{ __('admin.setting_general_setting') }} /</span> {{ __('admin.google_map') }}
              </h4>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <form method="POST" class=" needs-validation" novalidate action="{{ route('admin.update_map_config') }}" enctype="multipart/form-data"
                    class="card-body">
                    @csrf
                  <div class="card mb-4">
                    <div class="card-body">
                      <div class="row">
                        {{-- Api key client --}}
                        <div class="col-md-6">
                            <label class="form-label" for="server_key">{{  __('admin.google_map_server_key')
                                }}</label>
                            <input required   type="text" name="server_key" id="server_key"
                            value="{{ $data->server_key??'' }}"
                                class="form-control @error('server_key') is-invalid @enderror" placeholder="{{ __('admin.google_map_server_key') }}"/>
                            @error('server_key')
                        ...
                        {{-- Server key client --}}
                        <div class="col-md-6 ">
                            <label class="form-label" for="client_key">{{  __('admin.google_map_client_key')
                                }}</label>
                            <input required   type="text" name="client_key" id="client_key"
                                class="form-control @error('client_key') is-invalid @enderror"
                                value="{{ $data->client_key??'' }}"
                                placeholder="{{ __('admin.google_map_client_key') }}" />
                            @error('client_key')
                            <div class="alert alert-danger error-message">{{ $message }}</div>
                            @enderror
                        </div>
