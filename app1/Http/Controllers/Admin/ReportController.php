...
class ReportController extends Controller
{
    ...
    public function paymentsReport()
    {
        ...
        $data['cod_vendor_balance'] =Payment::whereIn('id', $all_payments->pluck('id'))->where('deleted_at', Null)->where('payment_method_id', 1)->where('due_amount','>',0)->sum('due_amount');
        ...
        $data['tr_bank_vendor_balance'] = Payment::whereIn('id', $all_payments->pluck('id'))->where('deleted_at', Null)->where('payment_method_id', 2)->where('due_amount','>',0)->sum('due_amount');
        ...
        $data['vendor_account'] =  Payment::whereIn('id', $all_payments->pluck('id'))->where('deleted_at', Null)->where('payment_method_id', 3)->where('due_amount','<',0)->sum('due_amount');
