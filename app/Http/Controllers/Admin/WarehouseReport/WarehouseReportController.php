...
namespace App\Http\Controllers\Admin\WarehouseReport;
...
class WarehouseReportController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->input('action') == 'report') {
            ...
            return  view('admin.warehouse_report.reports.warehouse_report', compact('companies', 'branches', 'products', 'from', 'to', 'query'));
        } else {
            $query = $query->orderby('date', 'desc')->paginate(10);
            return view('admin.warehouse_report.index', compact('companies', 'branches', 'products', 'from', 'to', 'query'));
        }
    }
