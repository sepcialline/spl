<x-employee-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 breadcrumb-wremployeeer mb-4">
            {{-- <span class="text-muted fw-light"> {{ __('admin.branch_branch_manager') }} / </span> --}}
            {{ __('admin.products_products_add') }}
        </h4>
        <div class="card p-3  mb-4">
            <form method="POST" class=" needs-validation" novalidate action="{{ route('employee.products_update') }}"
                ...
                <div class="row pt-3  g-3 ">
                    ...
                    <div class="col-md-6">
                        ...
                        <input required type="text" name="product_code" id="product_code"
                            ...
                            value="{{ $product->code }}" placeholder="{{ __('admin.products_product_code') }}" />
                        @error('product_code')
                            <div class="alert alert-danger error-message">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group mb-3">
                            <input type="number" id="price" name="price" value="{{ $product->price }}"
                                class="form-control @error('price') is-invalid @enderror" required placeholder=""
                                aria-label="" step="0.01" min="0" />
                        </div>
                    </div>

                    <div class="col-md-6">
                        <label for="company_id" class="form-label">{{ __('admin.products_product_company') }}</label>
                        <select class="form-select" id="company_id"  aria-label="Default select example" name="company_id">
                    ...
                    <div class="col-md-6">
                        <div class="avatar avatar-xl mb-3">
                            @if($product->image)
                                <img id="image" src="{{ asset('build/assets/img/uploads/products/'. $product->image) }}"
