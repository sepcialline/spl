<div class="row">
    <div class="col-2">
        {{-- Edit Role Button --}}
        @if (Auth::guard('employee')->user()->can('employee-role-edit'))
    ...
    <div class="col-2">
        @if (Auth::guard('employee')->user()->can('employee-role-show'))
            {{-- Show Role Button --}}
    ...
    <div class="col-2 mx-2">
        @if (Auth::guard('employee')->user()->can('employee-role-delete'))
            {{-- Delete Role Button --}}
            <form method="POST" action="{{ route('employee.roles_employee_destroy', $role->id) }}">
                @csrf
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-add-new-role">
        <div class="modal-content p-3 p-md-5">
            ...
            <div class="modal-body">
                ...
                <!-- Add role form -->
                <form action="{{ route('employee.roles_employee_update') }}" method="post" class="needs-validation"
                    novalidate>
                    @csrf
