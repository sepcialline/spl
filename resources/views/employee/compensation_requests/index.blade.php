        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="{{ route('employee.compensation_request_create') }}"
                            ...
                            @foreach ($requests as $request)
                                <tr>
                                    ...
                                    <td>{{ $request?->company?->name }}
                                        <strong>#{{ $request?->company?->account_number }}#</strong> </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            @if($request->operation_check == 0 && $request->ceo_check == 0)
                                            <div class="mx-2">
                                                <a href="{{route('employee.compensation_request_edit',$request->id)}}"
                                                    class="btn btn-xs btn-label-success">{{ __('admin.edit') }}</a>
                                            </div>
                                            @endif
                                            <div class="mx-2">
                                                <a href="{{route('employee.compensation_request_show',$request->id)}}"
