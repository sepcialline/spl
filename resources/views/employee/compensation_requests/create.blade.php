<x-employee-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="py-3 breadcrumb-wrapper mb-4">
            ...
            {{ __('admin.compensation_request') }} / {{ __('admin.accounts_add_new') }}
        </h4>

        <div class="card">
            <div class="card-body">
                <form class="was-validated" enctype="multipart/form-data" method="post" action="{{route('employee.compensation_request_store')}}">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <textarea name="store_report" id="store_report" class="form-control" cols="30" rows="7" required></textarea>
                        </div>
                        <div class="col">
