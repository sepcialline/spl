<x-employee-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-body">
                <form class="was-validated" enctype="multipart/form-data" method="post" action="{{route('employee.compensation_request_update')}}">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md mb-4">
                            ...
                            <input type="date" class="form-control" value="{{\Carbon\Carbon::parse($request?->date)->format('Y-m-d')}}" name="date" required>
                        </div>
                        <div class="col-md mb-4">
                            <label for="select2Multiple" class="form-label">{{ __('admin.shipments_company_name') }}</label>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <textarea name="store_report" id="store_report" class="form-control" cols="30" rows="7" required>{{$request?->store_report}}</textarea>
                        </div>
                        <div class="col">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody id="table-body">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" value="{{$info->shipment}}" name="shipment_no[]" class="form-control" required></td>
                                            <td><input type="text" value="{{$info->amount}}" name="amount[]" class="form-control" required></td>
                                            <td>
                                ...
                                <button type="button" class="btn btn-xs add_row btn-label-facebook"><i class='bx bx-message-square-add'></i></button>
                            </div>
                        </div>
                    </div>
