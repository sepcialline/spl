<x-employee-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card p-3  mb-4">
            <form method="POST" class=" needs-validation" novalidate action="{{ route('employee.employee_profile_update') }}"
                ...
                <div class="row pt-3  g-3 ">
                    ...
                    <div class="col-md-4">
                        <label for="user_city" class="form-label">{{ __('admin.user_management_admin_city') }}</label>
                    ...
                    <div class="col-md-12">
                        <label class="form-label" for="admin_desc">{{ __('admin.user_management_admin_desc') }}</label>
                    ...
                    <div class="col-md-4">
                        <div class="avatar avatar-xl mb-3">
                            @if ($data->photo)
                                <img id="avatar"
                                    src="{{ asset('build/assets/img/uploads/avatars/' . $data->photo) }}"
                                    alt="{{ __('admin.user_management_admin_avatar') }}">
                            @else
                                <img id="avatar" src="{{ asset('build/assets/img/uploads/avatars/1.png') }}"
                                    alt="{{ __('admin.user_management_admin_avatar') }}">
                            @endif
