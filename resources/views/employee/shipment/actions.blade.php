    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row invoice-preview">
            ...
            <div class="col-xl-3 col-md-4 col-12 invoice-actions">
                    ...
                    <div class="card-body">
                        ...
                        @if (Auth::guard('employee')->user()->can('employee-Shipment-print'))
                            <a class="btn btn-label-secondary d-grid w-100 mb-3" target="_blank"
                                href="{{ route('employee.shipment_print_invoice', ['id' => $shipment->id]) }}">
                                {{ __('admin.print_invoice') }} & {{ __('admin.download_pdf') }}</a>
                        @endif
                        @if (Auth::guard('employee')->user()->can('employee-Shipment-edit'))
                            <a href="{{ route('employee.shipments_edit', ['id' => $shipment->id]) }}"
                        ...
                        @if (Auth::guard('employee')->user()->can('employee-Shipment-print'))
                            <a href="{{ route('employee.shipment_print_sticker', ['id' => $shipment->id]) }}"
                ...
                <a class="btn btn-label-danger my-2"
                    href="{{ route('employee.shipments_index') }}">{{ __('admin.back') }}</a>
            </div>
            <!-- /Invoice Actions -->
        </div>
        ...
        <div class="offcanvas offcanvas-end" id="assign_to_rider" aria-hidden="true">
            ...
            <div class="offcanvas-body flex-grow-1">
                <form action="{{ route('employee.shipment_assign_rider') }}" method="post" id="actions"
        ...
        <div class="offcanvas offcanvas-end" id="change_status" aria-hidden="true">
            ...
            <div class="offcanvas-body flex-grow-1">
                <form action="{{ route('employee.shipments_change_status') }}" method="post"
                    ...
                    @else
                        ...
                        <div class="mb-3">
                            ...
                            <select id="select2Multiple1 " class="select2 form-select change_status_id"
