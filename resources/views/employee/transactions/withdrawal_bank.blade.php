<x-employee-layout>
    ...
    @section('title')
        {{ __('admin.transactions') }} | {{ __('admin.transactions_Withdrawal_from_bank') }}
    @endsection
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="py-3 breadcrumb-wrapper mb-4">
            ...
            {{ __('admin.transactions_Withdrawal_from_bank') }}
        </h4>
                    ...
                    <div class="row">
                        <div class="col-md mb-4">
                            <label for="select2Multiple"
                                class="form-label">{{ __('admin.vendors_companies') }}</label>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><input type="checkbox" name="payments[]" value="{{ $payment->id }}"
                                        class="select-checkbox check"><br>
                                        @if($payment->image)
    ...
    @section('VendorsJS')
        ...
        <script>
            $(document).on('click', '#collect', function() {
                ...
                $.ajax({
                    method: 'POST',
                    url: "{{ route('employee.transactions_Withdrawal_from_bank') }}",
                    data: {
                        payments: payments
                    },
