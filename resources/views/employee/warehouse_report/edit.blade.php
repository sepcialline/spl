                                        ...
                                        <dd class="col-sm-6 d-flex justify-content-md-end">
                                            <div class="w-px-150">
                                                <input type="text"
                                                    ...
                                                    value="{{ $shipment->shipment_refrence }}" required
                                        ...
                                        <dd class="col-sm-6 d-flex justify-content-md-end">
                                            <div class="w-px-150">
                                                <input type="text" class="form-control date-picker"
                                                    name="created_date" value="{{ \Carbon\Carbon::parse($shipment->created_date) }}"
                                            ...
                                            <label class="form-label"
                                                ...
                                                @foreach ($emirates as $emirate)
                                                    ...
                                                    <option value="{{ $emirate->id }}"
                                                        {{ $user->emirate_id == $emirate->id ? 'selected' : '' }}>
                                                        {{ $emirate->name }}</option>
                                                @endforeach
                                            </select>
                                            <div class="invalid-feedback">{{ __('admin.this_field_is_required') }}
                            ...
                            <div class="row p-sm-3 p-0">
                                <div class="col-md-12 col-sm-12 col-12 mb-sm-0 mb-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4" style="border-left: 1px solid #bbbb">
                                            <div class="col mb-3">
                                                <div class="mb-3 col">
                                                    <label class="form-label"
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($branches as $branche)
                                                            <option value="{{ $branche->id }}"
                                                                {{ $shipment->branch_created_id == $branche->id ? 'selected' : '' }}>
                                                ...
                                                <div class="mb-3 col">
                                                    ...
                                                    <select
                                                        ...
                                                        @foreach ($branches as $branche)
                                                            <option value="{{ $branche->id }}"
                                                                {{ $shipment->branch_destination_id == $branche->id ? 'selected' : '' }}>
                                                                {{ $branche->branch_name }}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="invalid-feedback">
