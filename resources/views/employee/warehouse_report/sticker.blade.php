...
<body class="A5 landscape" >
    ...
    <section class="sheet padding-10mm p-3 mx-auto" style="border:2px solid #ffd200">

        <div class="d-flex justify-content-between invoice-print">

            <div class="mx-2 px-2 float-start">
                <img width="75%"
                    src="{{ asset('build/assets/img/logo/logo_' . LaravelLocalization::getCurrentLocale() . '.png') }}">
            </div>

            <div class="mx-2 px-2 float-none">
                {!! $barcode !!}
                {{ $shipment->shipment_no }}#{{ $shipment->shipment_refrence }}
            </div>
            <div class="mx-2 px-2 float-end">
                <p class="" style="width:50%">{{ __('admin._company_address_') }}</p>
            </div>
        </div>
        ...
        <div class="row d-flex justify-content-between mb-4">
            <div class="col-sm-6 w-50">
                ...
                <table>
                    <tbody>
                        ...
                        <p class="mb-1">{{ $shipment->Company->address ?? '' }} - {{ $shipment->Company->city->name ?? '' }} - {{$shipment->Company->emirate->name ?? '' }}</p>
                        </tr>
                        <tr>
            ...
            <div class="col-sm-6 w-50">
                ...
                <p class="mb-1">{{ $shipment->Client->address ?? '' }} - {{ $shipment->Client->city->name ?? '' }} - {{$shipment->Client->emirate->name ?? '' }}</p>
            </div>
