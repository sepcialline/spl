        ...
        <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            ...
            <div class="navbar-nav align-items-center">
                <div class="nav-item navbar-search-wrapper mb-0">
                    <form action="{{route('vendor.shipment.search')}}" method="post">
                    @csrf
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <a class="dropdown-item" href="#">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        <span
                                            class="fw-semibold d-block lh-1">{{ Auth::guard('vendor')->user()->name }}
                                        </span>
                                        @foreach (Auth::guard('vendor')->user()->roles->pluck('name') as $role)
                                            <span class="btn btn-label-facebook btn-sm">{{ $role }}</span>
                                        @endforeach
                                    </div>
                                </div>
                            </a>
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ route('vendor.vendor_profile_index') }}">
