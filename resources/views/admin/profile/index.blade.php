                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        ...
                        <div class="d-flex justify-content-around mb-4">
                            <a href="{{ route('admin.admin_profile_edit') }}"
                            ...
                            <a href="{{ url()->previous() }}" class="btn btn-label-info">{{ __('admin.back') }}</a>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog modal-simple modal-enable-otp modal-dialog-centered">
                            <div class="modal-content p-3 p-md-5">
                                <div class="modal-body">
                                    ...
                                    <form id="update_passwordForm" method="post" action="{{route('admin.admin_update_password')}}" class="row g-3 needs-validation" novalidate>
                                        @csrf
                                        <div class="col-12">
                                            <label class="form-label"
                                                for="modalEnableOTPPhone">{{ __('admin.current_password') }}</label>
