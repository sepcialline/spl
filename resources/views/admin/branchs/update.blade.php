                        ...
                        <div class="row g-3">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select name="branch_status" value="{{ $data->status }}"
                                    ...
                                    {{-- <option selected>Open this select menu</option> --}}
                                    <option value="0" {{$data->status == 0 ? 'selected' : ''}}>{{ __('admin.deactivate') }}</option>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="is_main" value="{{ old('is_main') }}"
                                    ...
                                    {{-- <option selected>Open this select menu</option> --}}
                                    <option value="0" {{$data->is_main == 0 ? 'selected' : ''}}>{{ __('admin.no') }}</option>
                                    <option value="1" {{$data->is_main == 1 ? 'selected' : ''}}>{{ __('admin.yes') }}</option>
                                </select>
                                @error('is_main')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
