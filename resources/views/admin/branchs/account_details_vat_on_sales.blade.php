    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row gy-4">
            ...
            <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                <!-- User Pills -->
                @include('admin.branchs.includes.nav_list', ['active' => 'vat_on_sales', 'branch' => $branch])
                <!--/ User Pills -->

                @include('admin.branchs.includes.add_account', ['store' => 'vat_on_sales', 'branch' => $branch,'account' =>$vat_on_sales])
                <!-- Project table -->
                {{-- <div class="card mb-4">
