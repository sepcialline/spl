<x-app-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 breadcrumb-wrapper mb-4">
            ...
            {{ __('admin.accountant_details') }} / {{ __('admin.revenues') }}
        </h4>
        <div class="row gy-4">
            <!-- User Sidebar -->
            ...
            <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                <!-- User Pills -->
                @include('admin.branchs.includes.nav_list', ['active' => 'rev', 'branch' => $branch])
                <!--/ User Pills -->

                @include('admin.branchs.includes.add_account', ['store' => 'rev', 'branch' => $branch,'account' =>$rev_account])
                <!-- Project table -->
                {{-- <div class="card mb-4">
