<x-app-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 breadcrumb-wrapper mb-4">
            ...
            {{ __('admin.branch_add_branch') }}
        </h4>
        <div class="card p-3  mb-4">
            <form method="POST" class=" needs-validation" novalidate action="{{ route('admin.branch_store') }}"
                enctype="multipart/form-data" class="card-body">
                @csrf
                <div class="row pt-3  g-3 ">
                    <div class="col-md-6">
                        <label class="form-label"
                            for="branch_english_name">{{ __('admin.branch_branch_english_name') }}</label>
                    ...
                    <div class="col-md-6">
                        <label class="form-label"
                            for="branch_arabic_name">{{ __('admin.branch_branch_arabic_name') }}</label>
                        <input required type="text" name="branch_arabic_name" id="branch_arabic_name"
                            class="form-control  @error('branch_arabic_name') is-invalid @enderror"
                            placeholder="{{ __('admin.branch_branch_arabic_name') }}"
                            value="{{ old('branch_arabic_name') }}" />
                    ...
                    <div class="col-md-12">
                        <label class="form-label"
                            for="branch_english_address">{{ __('admin.branch_english_address') }}</label>
                        <input required type="text" name="branch_english_address" id="branch_english_address"
                            class="form-control" placeholder="{{ __('admin.branch_english_address') }}"
                            value="{{ old('branch_english_address') }}" />
                    </div>
                    <div class="col-md-12">
                        <label class="form-label"
                            for="branch_arabic_address">{{ __('admin.branch_arabic_address') }}</label>
                        <input required type="text" name="branch_arabic_address" id="branch_arabic_address"
                            class="form-control" placeholder="{{ __('admin.branch_arabic_address') }}"
                            value="{{ old('branch_arabic_address') }}" />
                    </div>
                </div>
                <hr class="my-4 mx-n4" />
                <div class="row  g-3">
                    <div class="col-md-6">
                        <div class="row mb-3 g-3">
                            <div class=" col-md-6">
                                ...
                                <input required type="text" id="landline" name="landline"
                                    class="form-control  @error('landline') is-invalid @enderror"
                                    placeholder="{{ __('admin.landline') }}" value="{{ old('landline') }}"
                            ...
                            <div class=" col-md-6">
                                ...
                                <input required type="text" id="mobile" name="mobile"
                                    ...
                                    value="{{ old('mobile') }}" placeholder="{{ __('admin.setting_mobile') }}"
                            ...
                            <div class=" col-md-6">
                                ...
                                <input required type="email" value="{{ old('email') }}" id="email"
                            ...
                            <div class="col-md-6">
                                ...
                                <input required type="number" id="postal_code" value="{{ old('postal_code') }}"
                        ...
                        <div class="row g-3">
                            <div class="  col-md-6">
                                ...
                                <select class="form-select   @error('emirates') is-invalid @enderror"
                                    value="{{ old('emirates') }}" id="emirates" name="emirates"
                                    class="custom-select ">
                            ...
                            <div class=" col-md-6">
                                <label for="branch_percentage"
                                    class="form-label">{{ __('admin.branch_percentage') }}</label>
                                <select name="branch_percentage" value="{{ old('branch_percentage') }}"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select name="branch_status" value="{{ old('branch_status') }}"
                                    class="form-select  @error('branch_status') is-invalid @enderror"
                                    id="branch_status" aria-label="branch_status select example">
                                    {{-- <option selected>Open this select menu</option> --}}
                            ...
                            <div class=" col-md-6">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input required type="number" value="{{ old('percentage_in') }}"
                                            id="percentage_in" name="percentage_in"
                                    ...
                                    <div class=" col-md-6">
                                        ...
                                        <input required type="number" value="{{ old('percentage_out') }}"
                                            id="percentage_out" name="percentage_out"
                                            class="form-control  @error('percentage_out') is-invalid @enderror"
                                            placeholder="{{ __('admin.out') }}"
                                            aria-label="{{ __('admin.out') }}" />
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <label for="is_main"
                                    class="form-label">{{ __('admin.branch_branch_is_main') }}</label>
                    ...
                    <div class="col-md-12 row">
                        ...
                        <div class="col-1">
                            ...
                            <a href="{{ route('admin.branch_index') }}"
