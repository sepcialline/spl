        ...
        <div class="card">
            <div class="card-body">
                <form class="was-validated" enctype="multipart/form-data" method="post"
                    action="{{ route('admin.compensation_request_store') }}">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody id="table-body">
                                        <tr>
                                            <td><input type="text" name="shipment_no[]" class="form-control"
                                                    required></td>
                                            <td><input type="text" name="amount[]" class="form-control" required>
                                            </td>
                                            <td>
                                                <div class="d-flex justify-center">
                                                    <button type="button" class="btn btn-xs btn-danger delete_row"><i
