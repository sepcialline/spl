                    ...
                    <table class="dt-scrollableTable table table-bordered">
                        ...
                        @foreach ($products as $product)
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="modal fade" id="transfer{{ $product->id }}" tabindex="-1" aria-hidden="true">
                                        ...
                                        <div class="modal-content p-3 p-md-5">
                                            ...
                                            <form id="import_export_product" class="row g-3 mt-3" method="POST"  novalidate action="{{ route('admin.transfer_product_store') }}">
                                                @csrf
                                                ...
                                                <div class="col-12 row">
                                                    ...
                                                    <div class="col-6">
                                                        <label class="form-label mt-2" for="modalEnableOTPPhone">{{ __('admin.warehouse_transfer_quantity') }}</label>
                                                        <div class="input-group input-group-merge ">
                                                            <input
                                                                type="number"
                                                    ...
                                                    <div class="col-12">
                                                        <label for="from_branch" class="form-label">{{ __('admin.from') }}</label>
                                                        <select class="form-select " id="from_branch"   aria-label="Default select example" name="from_branch">
                                                    ...
                                                    <div class="col-12">
                                                        <label for="to_branch" class="form-label">{{ __('admin.to') }}</label>
                                                        <select class="form-select " id="to_branch"   aria-label="Default select example" name="to_branch">
                                                            @foreach ($branches as $branch )
                                                                <option value={{ $branch->id }}>{{ $branch->branch_name }}</option>
                                                            @endforeach
                                                        </select>
                                    ...
                                    <a data-bs-toggle="modal" data-bs-target="#transfer{{ $product->id }}" class="btn btn-label-info" data-url="{{ route('admin.transfer_update',$product->product_id) }}"
                                        >{{ __('admin.warehouse_transfer') }}</a>
                                </td>
                            </tr>
