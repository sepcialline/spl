<x-app-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card p-3  mb-4">
            <form method="POST" class=" needs-validation" novalidate action="{{ route('admin.city_store') }}" enctype="multipart/form-data"
                class="card-body">
                @csrf
                <div class="row pt-3  g-3 ">
                    ...
                    <div class="col-md-12">
                        ...
                        <select class="form-select   @error('emirates') is-invalid @enderror"
                            value="{{ old('emirates') }}" id="emirates" name="emirates" class="custom-select ">
