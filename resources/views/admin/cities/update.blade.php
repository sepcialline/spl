<x-app-layout>
    @section('title')
    {{ __('admin.city_city_manager') }} / {{ __('admin.city_city_add') }}
    @endsection
    @section('VendorsCss')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 breadcrumb-wrapper mb-4">
            <span class="text-muted fw-light"> {{ __('admin.city_city_manager') }} / </span>
            {{ __('admin.city_city_add') }}
        </h4>
        <div class="card p-3  mb-4">
            <form method="POST" class=" needs-validation" novalidate action="{{ route('admin.city_update',$data->id) }}" enctype="multipart/form-data"
                class="card-body">
                @csrf
                <div class="row pt-3  g-3 ">
                    <div class="col-md-6">
                        <label class="form-label" for="city_english_name">{{  __('admin.city_city_name_english')
                            }}</label>
                        <input required   type="text" name="city_english_name" id="city_english_name"
                            class="form-control @error('city_english_name') is-invalid @enderror"
                            value="{{ $data->getTranslation('name','en') }}"
                            placeholder="{{ __('admin.city_city_name_english') }}" />
                        @error('city_english_name')
                    ...
                    <div class="col-md-6">
                        <label class="form-label" for="city_arabic_name">{{  __('admin.city_city_name_arabic')
                            }}</label>
                        <input required   type="text" name="city_arabic_name" id="city_arabic_name"
                            class="form-control @error('city_arabic_name') is-invalid @enderror"
                            value="{{ $data->getTranslation('name','ar') }}"
                            placeholder="{{ __('admin.city_city_name_arabic') }}" />
                        @error('city_arabic_name')
                        <div class="alert alert-danger error-message">{{ $message }}</div>
                        @enderror
                        {{-- <div class="valid-feedback"> Looks good! </div>
                        <div class="invalid-feedback"> Please enter your name. </div> --}}
                    ...
                    <div class="col-md-12">
                        ...
                        <select class="form-select   @error('emirates') is-invalid @enderror"
                            value="{{ $data->emirates }}" id="emirates" name="emirates" class="custom-select ">
                            @foreach ($data->emirates as $emirate)
                                <option value="{{ $emirate->id }}" {{$emirate->id == $data->emirate_id ? 'selected' : ''}}>{{ $emirate->name }}</option>
                            @endforeach
                        </select>
                        @error('emirates')
                ...
                <div class="row  g-3 mt-4">
                    ...
                    <div class="col-md-12 row">
                        ...
                        <div class="col-1">
                            ...
                            <a href="{{ route('admin.city_index') }}" class="btn btn-label-danger">{{ __('admin.back')
                                }}</a>
