                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        ...
                        <div class="d-flex justify-content-around mb-4">
                            <a href="edit/{{ $data['id'] }}"
                                class="btn btn-sm btn-label-dark">{{ __('admin.branch_action_edit') }}</a>
                            {{-- <a data-url="{{ route('admin.users_rider_destroy', $data['id']) }}"
                                class="btn btn-sm btn-label-danger delete">{{ __('admin.branch_action_delete') }}</a> --}}
                            <a href="{{ $data['id'] }}" data-bs-toggle="modal" data-bs-target="#update_password"
                                class="btn btn-sm btn-label-warning">{{ __('admin.change_password') }}</a>
                            <a href="{{ route('admin.users_rider_index') }}"
                                class="btn btn-sm btn-label-info">{{ __('admin.back') }}</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-8">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-3">
                                    <p class="mb-0"> {{ __('admin.user_management_admin_name') }}</p>
                                </div>
                                <div class="col-sm-9">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <p class="mb-0">{{ __('admin.user_management_admin_email') }}</p>
                                </div>
                                <div class="col-sm-9">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <p class="mb-0">{{ __('admin.user_management_rider_status') }}</p>
                                </div>
                                <div class="col-sm-9">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <p class="mb-0">{{ __('admin.user_management_rider_vehicle_type') }}</p>
                                </div>
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">{{ $data->vehicleType->name }}</p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-sm-3">
                                    <p class="mb-0">{{ __('admin.user_management_rider_branch') }}</p>
                                </div>
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">
                                        {{ $data->branch->branch_name ?? __('admin.not_assigned') }}</p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-sm-3">
                                    <p class="mb-0">{{ __('admin.user_management_rider_address_english') }}</p>
                                </div>
                                <div class="col-sm-9">
