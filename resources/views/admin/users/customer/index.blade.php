    ...
    <div class="container-xxl flex-grow-1 container-p-y ">
        ...
        <div class="card p-4">
            <div class="d-flex justify-content-sm-between align-items-sm-center">
                <h5 class="card-header"><i class="bx bx-user"></i></h5>
                <div class="d-flex ">
                    <div class="form-outline me-2">
                        ...
                        <input type="search" id="form1" class="form-control" placeholder="Type query"
                            ...
                            data-url="{{ route('admin.users_customer_search', '') }}" />
                    </div>
            ...
            <div class="table-responsive text-nowrap">
                                    ...
                                    {{-- <td>
                                            <label class="switch switch-primary">
                                                <input type="checkbox" class="switch-input status"
                                                    data-url="{{ route('admin.users_rider_update_status', $item['id']) }}" name="status"
                                                    id="status" {{ $item['status'] ? 'checked' : !'checked' }} />
                                    ...
                                    <td>
                                        ...
                                        {{-- <a href="edit/{{ $item['id'] }}"
                                            ...
                                            <a id="delete" class="btn btn-label-danger delete"
                                                data-url="{{ route('admin.users_customer_destroy', $item['id']) }}">{{ __('admin.branch_action_delete') }}</a> --}}
                                    </td>
                                </tr>
                            @endforeach
                ...
                @else
                    <img src="{{ asset('build/assets/img/uploads/pages/nodata') }}.png"
                        ...
                        success: function(data) {
                            ...
                            data.results.forEach(function(item, index) {
                                ...
                                output = output +
                                    '<tr>' +
                                    '<td>' +
                                    `<img src="{{ asset('build/assets/img/uploads/avatars/${item.photo}') }}" alt="Avatar" class="rounded-circle me-2" style="width:50px"/>` +
