        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row my-4">
                    <div class="col-md-3">
                        <div class="d-flex justify-content-end">
                            ...
                            <a class="btn btn-label-facebook"
                                href="{{ route('admin.account.edit_payment_voucher', $number - 1) }}">
                    ...
                    <div class="col-md-3">
                        <form id="searchForm" action="{{ route('admin.account.edit_payment_voucher', ':number') }}"
                            method="get">
                    ...
                    <div class="col">
                        ...
                        preg_match('/edit_payment_voucher\/(\d+)/', $fullUrl, $matches);
                    ...
                    @if ($number)
                        <a href="{{ route('admin.account.print_payment_voucher', $number) }}" class="btn btn-outline-success"><i
                                class="bx bx-printer"></i></a>
                        @include('admin.transactions.vouchers.include.delete_form',['number'=>$number,'type'=> 3])
                    @else
                ...
                <form action="{{ route('admin.account.update_payment_voucher') }}" method="post"
