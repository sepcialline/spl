    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row my-4">
                    <div class="col-md-3">
                            <div class="d-flex justify-content-end">
                                ...
                                <a class="btn btn-label-facebook" href="{{route('admin.account.edit_recipt_voucher',$number-1)}}">
                ...
                <form action="{{ route('admin.account.store_recipt_voucher') }}" method="post"
                    ...
                    <div class="row mt-2">
                        ...
                        {{-- <div class="form-group col-2">
                            ...
                            <input name="shipment_refrence" class="form-control" id="shipment_refrence">
                        </div> --}}
                    ...
                    <div class="my-2">
                        ...
                        <button type="submit" class="btn btn-label-secondary save-btn" name="save_type" value="save_print">{{ __('admin.save_and_print') }}</button>
                        <button type="submit" class="btn btn-label-secondary save-btn" name="save_type" value="save">{{ __('admin.just_save') }}</button>
                    </div>
                </form>
            </div>
        </div>
