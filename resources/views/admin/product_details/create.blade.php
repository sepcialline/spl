<x-app-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card p-3  mb-4">
            <form method="POST" class=" needs-validation" novalidate action="{{ route('admin.products_store') }}"
                ...
                <div class="row pt-3  g-3 ">
                    ...
                    {{-- <div class="col-md-6">
                        <label class="form-label"
                            for="product_code">{{ __('admin.products_product_code') }}</label>
                        <input required type="text" name="product_code" id="product_code"
                            class="form-control @error('product_code') is-invalid @enderror"
                            value="{{ old('product_code') }}"
                            placeholder="{{ __('admin.products_product_code') }}" />
                        @error('product_code')
                            <div class="alert alert-danger error-message">{{ $message }}</div>
                        @enderror
                    </div> --}}
