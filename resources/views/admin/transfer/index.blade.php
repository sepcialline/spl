            ...
            <div class="card p-4">
                <div class="d-flex justify-content-sm-between align-items-sm-center">
                    ...
                    <div class="d-flex align-items-sm-center">
                        <h5 class="card-header"> {{ __('admin.warehouse_transfer_list') }} </h5>
                        {{-- <span class="">
                        ...
                        @foreach ($data as $row)
                            ...
                            <tr>
                                ...
                                <td>
                                        ...
                                        <span class="{{ $row['status'] == 0 ? 'badge rounded-pill bg-label-danger' : 'badge rounded-pill bg-label-success' }}">
                                            {{ $row['status'] == 0 ?  __('admin.no') : __('admin.yes')  }}
                                        </span>
                                ...
                                <td>
                                    ...
                                    {{-- <a href="{{ route('admin.warehouse_edit',$row['id']) }}"
                                        class="btn btn-label-secondary">{{ __('admin.branch_action_edit') }}</a>

                                    <a id="delete" class="btn btn-label-danger delete"
                                        data-url="{{ route('admin.warehouse_destroy', $row['id']) }}">{{ __('admin.branch_action_delete') }}</a> --}}
                                </td>
                            </tr>
