    ...
    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-md-0 mb-4">
                                <div class="d-flex svg-illustration mb-4 gap-2">
                                    <img src="{{ asset('build/assets/img/logo/logo_' . LaravelLocalization::getCurrentLocale() . '.png') }}" width="25%"
                                        alt="">
                    ...
                    <div class="card-body">
                        <div class="row p-sm-3 p-0">
                            <div class="col-xl-6 col-md-12 col-sm-5 col-12 mb-xl-0 mb-md-4 mb-sm-0 mb-4">
                                ...
                                <p class="mb-1">{{ $shipment->Client?->city->name ?? '' }}</p>
                                <p class="mb-1">{{ $shipment->Client?->emirate->name ?? '' }}</p>
        ...
        <div class="offcanvas offcanvas-end" id="assign_to_rider" aria-hidden="true">
            ...
            <div class="offcanvas-body flex-grow-1">
                <form action="{{ route('admin.shipment_assign_rider') }}" method="post"
