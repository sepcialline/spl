...
@endif
            <form method="POST" class=" needs-validation" novalidate action="{{ route('vendor.vendor_profile_update') }}"
                ...
                <div class="row  g-3">
                    ...
                    <div class="row my-4" >
                        <div class="col">
                            ...
                            <select name="companies[]" disabled id="companies" class="js-example-basic-multiple"
                                multiple="multiple">
