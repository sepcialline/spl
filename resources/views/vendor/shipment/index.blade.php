    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-body">
                <form action="">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="branch_created" value="0">
            ...
            <div class="row px-4 py-1">
                <div class="col-md-4">
                    <a href="{{route('vendor.shipment.downloadfile')}}" class="btn btn-label-danger"><i class='bx bx-download'></i></a>
                    @include('vendor.shipment.includes.import_excel')
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-striped table-bordered my-2">
                            ...
                            <tbody>
                                ...
                                @php $sum = $sum + ($shipment->rider_should_recive - $shipment->specialline_due) @endphp
                                    <tr>
                                        ...
                                        <td>{{ ($shipment->rider_should_recive - $shipment->specialline_due) }}</td>
                                        <td><span
                                                class="{{ $shipment->Status->html_code }}">{{ $shipment->Status->name }}</span>
                                        </td>
                                        <td>
                                            @include('includes.shipment_action_dropdown_vendor', [
                                                'shipment' => $shipment,
                                            ])
                                        </td>
                                    </tr>
