<x-vendor-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row invoice-preview">
                    ...
                    <div class="card-body">
                        <div class="row p-sm-3 p-0">
                            <div class="col-xl-6 col-md-12 col-sm-5 col-12 mb-xl-0 mb-md-4 mb-sm-0 mb-4">
                                ...
                                <p class="mb-1">{{ $shipment->Client?->address ?? '' }}</p>
            ...
            <div class="col-xl-3 col-md-4 col-12 invoice-actions">
                ...
                <a class="btn btn-label-danger my-2"
                    href="{{ route('vendor.shipments_index') }}">{{ __('admin.back') }}</a>
            </div>
            <!-- /Invoice Actions -->
        </div>
        ...
        {{-- <div class="offcanvas offcanvas-end" id="assign_to_rider" aria-hidden="true">
            ...
            <div class="offcanvas-body flex-grow-1">
                <form action="{{ route('vendor.shipment_assign_rider') }}" method="post" id="actions" enctype="multipart/form-data"
                    ...
                    <div class="mb-3">
                        ...
                        <select id="select2Multiple1" class="select2 form-select" name="rider_id">
        ...
        {{-- <div class="offcanvas offcanvas-end" id="change_status" aria-hidden="true">
            ...
            <div class="offcanvas-body flex-grow-1">
                <form action="{{ route('vendor.shipments_change_status') }}" method="post"  enctype="multipart/form-data"
    ...
    @section('VendorsJS')
        ...
        <script>
            $(document).on('change', '#payment_divided', function() {
