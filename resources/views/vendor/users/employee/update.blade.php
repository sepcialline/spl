    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card p-3  mb-4">
            <form method="POST" class=" needs-validation" novalidate
                action="{{ route('vendor.users_employee_update') }}" enctype="multipart/form-data" class="card-body">
                @csrf
                ...
                <div class="row pt-3  g-3 ">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="employee_department" value="{{ old('employee_department') }}"
                            class="form-select  @error('employee_department') is-invalid @enderror" id="employeedepartment"
                            aria-label="employee_department select example">
                    ...
                    <div class=" col-md-4">
                        ...
                        <select name="employee_status" value="{{ old('employee_status') }}"
                    ...
                    <div class="col-md-4">
                        <label for="employee_emirate"
                            class="form-label">{{ __('admin.user_management_admin_emirate') }}</label>
                        <select name="employee_emirate" value="{{ old('employee_emirate') }}"
                            class="form-select  @error('user_emirate') is-invalid @enderror" id="employee_emirate"
                            aria-label="employee_emirate select example">
                    ...
                    <div class=" col-md-4">
                        ...
                        <select name="employee_is_sale" value="{{ $data->admin_is_sales }}"
                ...
                <div class="col-md-12 row mt-4">
                    ...
                    <div class="col-1">
                        ...
                        <a href="{{ route('vendor.users_employee_index') }}"
